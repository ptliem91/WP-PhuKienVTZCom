       ...
       <tbody>
          ...
          <tr>
             ...
             <td>
               ...
               Prints JSON-LD for the product table shortcode. One archive pages the JSON-LD is printed automatically.
             </td>
          </tr>
          <tr>
             <td>
...
<div class="wcpt-footer">
  ...
  <div class="wcpt-support wcpt-footer-note">
    <?php wcpt_icon('zap'); ?>
    <span>
      <?php _e( "WCPT PRO is ready for your shop! Build better, build faster.", "wc-product-table" ); ?>
