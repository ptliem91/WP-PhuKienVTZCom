...
>
  ...
  <div class="wcpt-editor-row-option">
    ...
    <?php
      ...
      ?>
      <label><?php wcpt_pro_radio('custom_field', 'Custom field containing URL', 'link'); ?></label>
      <label><?php wcpt_pro_radio('custom_field_media_id', 'Custom field containing Media ID', 'link'); ?></label>
      <?php
    ?>
  </div>
